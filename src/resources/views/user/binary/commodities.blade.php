        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="i-card-sm mb-4">
                                    ...
                                    <tr>
                                        <td data-label="{{ __('Pair') }}">
                                            <div
                                                ...
                                                <div class="icon">
                                                    <img src="{{ asset('assets/icons/' . $commodity->symbol . '.png') }}"
                                                        class="avatar--sm" alt="{{ __('Crypto-Image') }}">
                                                </div>
                                                <div class="content">
                                                    <h6 class="fs-14">{{ $commodity->symbol }}/USDT</h6>
                                                    <span class="fs-13 text--light">{{ $commodity->name }}</span>
                                                </div>
                                            </div>
                                        </td>

                                        <td data-label="{{ __('Action') }}">
                                            <a href="{{ route('user.binary.trade', ['commodity', $commodity->symbol]) }}"
                    ...
                    <div class="mt-4">{{ $commoditys->links() }}</div>
                </div>
            </div>
        </div>
    </div>
